...
import (
	...
	"github.com/textileio/near-api-go/hexutil"
)
...
func (bnh *BlockNumberOrHash) Hash() (Hash, bool) {
	if bnh.BlockHash != nil {
...
func BlockNumberOrHashWithHash(hash Hash, canonical bool) BlockNumberOrHash {
	return BlockNumberOrHash{
		BlockNumber:      nil,
		BlockHash:        &hash,
